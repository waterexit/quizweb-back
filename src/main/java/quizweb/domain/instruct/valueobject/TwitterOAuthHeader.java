package quizweb.domain.instruct.valueobject;
...
public class TwitterOAuthHeader {
	...
	public TwitterOAuthHeader(TwitterAPITokenProperties twitteAPITokenRequest, HttpRequestMethodEnum requestMethod,
		...
		oAuthParam.put(OAuthAttrsEnum.oauth_timestamp.name(), String.valueOf(System.currentTimeMillis()/1000l).replace("l", ""));
	}
	...
	private String urlEncode(String string) {
		try {
			...
			// TODO:実際にtwitterに投げて問題なさそうなら置換部分は消す
